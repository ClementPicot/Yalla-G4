            ...
            <div class="container">
              <div class="row infos_who">
                <div class="content_who col-md-6 col-xs-10">
                  ...
                  <hr>
                  <p>Culpa probant te nescius ut tempor voluptatibus cernantur tempor nescius.
                    Iis mentitum o arbitror in doctrina efflorescere in nostrud.
                  </p>
        ...
        <div class="container-fluid background_reseau">
          <div class="container">
            <div class="row">
              ...
              <a href="#"><img src="img-content/facebook.png" alt="facebook"></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container-fluid">
          <div class="content_partenaire col-md-12">
            ...
            <div class="thumb_partenaire">
              <img class="col-md-4" src="img-content/calam.jpeg" alt="calam">
              <img class="col-md-4" src="img-content/institut.jpg" alt="institut française">
              <img class="col-md-4" src="img-content/womens.png" alt="women's world wide web">
            </div>
          </div>
        </div>
      </section>
